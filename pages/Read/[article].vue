<template>
  <div class="container">
    <div class="my-4">
      <img
        :src="`https://board.humm.world/assets/${recipe.translations[0].cover.id}?fit=cover&width=1300&height=650&quality=80`"
        class="w-100"
  ...
  <div class="container mt-5">
    <div class="d-flex align-items-center justify-content-between mb-4">
      <h2 class="h1">أحدث المقالات</h2>
      <NuxtLink to="/read" class="appBtn"
        >عرض المزيد
        <Icon
